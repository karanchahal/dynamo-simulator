...
import bidirect_pb2 as bidirect__pb2
...
class GRPCDemoStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SimpleMethod = channel.unary_unary(
                ...
                request_serializer=bidirect__pb2.Request.SerializeToString,
                response_deserializer=bidirect__pb2.Response.FromString,
                )
...
def add_GRPCDemoServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SimpleMethod': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=bidirect__pb2.Request.FromString,
                    response_serializer=bidirect__pb2.Response.SerializeToString,
            ),
...
class GRPCDemo(object):
    ...
    def SimpleMethod(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/demo.GRPCDemo/SimpleMethod',
            bidirect__pb2.Request.SerializeToString,
            bidirect__pb2.Response.FromString,
